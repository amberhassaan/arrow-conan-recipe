...
class ArrowConan(ConanFile):
    ...
    def source(self):
        tools.get(f"https://github.com/apache/arrow/archive/refs/tags/apache-arrow-{self.version}.tar.gz")
    ...
    def _configure_cmake(self):
        ...
        self._cmake.definitions["ARROW_PYTHON"] = self.options.python
        ...
        self._cmake.configure(source_folder=f"arrow-apache-arrow-{self.version}/cpp")
        return self._cmake
